...
namespace CalendarSystem.DataStorage
{
    ...
    interface IStorage
    {
        ...
        void SaveEvent(string description, DateTime? dateTime, TimeSpan? timeSpan, INotification notification);
        /// <summary>
        ...
        /// <param name="timeSpan"></param>
        /// <param name="notification"></param>
        void UpdateEvent(int ID, string description, DateTime? dateTime, TimeSpan? timeSpan, INotification notification);
        /// <summary>
