...
namespace Northwind.Model
{
    class ProductCSV
    {
        ...
        private CategoryCSV _category { get; set; }
        ...
        public ProductCSV(int id, string name, CategoryCSV category, string quantityPerUnit, decimal unitPrice, int unitsInStock, int unitsOnOrder, int reorderLevel, bool discontinued)
        {
            _id = id;
            _name = name;
            _category = category;
